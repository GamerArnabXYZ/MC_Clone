...
// include: /tmp/tmp4g1dy71b.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'voxelcraft.data';
      var REMOTE_PACKAGE_BASE = 'voxelcraft.data';
...
Module['FS_createPath']("/assets", "textures", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_voxelcraft.data');

      };
      Module['addRunDependency']('datafile_voxelcraft.data');
    ...
    loadPackage({"files": [{"filename": "/assets/textures/.gitkeep", "start": 0, "end": 265}], "remote_package_size": 265});

  })();

// end include: /tmp/tmp4g1dy71b.js
