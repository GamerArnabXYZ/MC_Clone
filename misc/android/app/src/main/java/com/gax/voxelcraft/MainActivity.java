...
public class MainActivity extends Activity 
{
	...
	class CCSurfaceCallback implements SurfaceHolder.Callback {
		...
		public void surfaceDestroyed(SurfaceHolder holder) {
			...
			//08-02 21:03:02.967: E/BufferQueueProducer(1350): [SurfaceView - com.gax.voxelcraft.VoxelCraft/com.gax.voxelcraft.MainActivity#0] disconnect: not connected (req=2)
			//08-02 21:03:02.968: E/SurfaceFlinger(1350): Failed to find layer (SurfaceView - com.gax.voxelcraft.VoxelCraft/com.gax.voxelcraft.MainActivity#0) in layer parent (no-parent).
