...
// This class contains all the glue/interop code for bridging VoxelCraft to the java Android world.
...
public class MainActivity extends Activity 
{
	...
	class CCSurfaceCallback implements SurfaceHolder.Callback {
		...
		public void surfaceDestroyed(SurfaceHolder holder) {
			...
			//08-02 21:03:02.968: E/SurfaceFlinger(1350): Failed to find layer (SurfaceView - com.voxelcraft.VoxelCraft/com.voxelcraft.MainActivity#0) in layer parent (no-parent).
