...
/* VoxelCraft patch - don't export FreeType symbols in debug builds to avoid conflicting with system */
#if defined(__GNUC__) && !defined(_WIN32) && !defined(__sun__) && !defined CC_BUILD_MSDOS
