...
static void CCTextures_DownloadAssets(void) {
	static cc_string url = String_FromConst("https://cdn.classicube.net/client/default.zip");
	if (ccTexturesExist) return;
...
/* Mojang/ClassiCube texture sources removed - use default.zip from CDN directly */
#define DEFAULTZIP_0030_ENTRIES_COUNT 0
static struct ZipfileSource defaultZipSources_0030_0023[] = {{ 0 }};
