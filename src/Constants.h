...
#define GAME_APP_ALT   "VoxelCraft 1.0.0 web mobile"
#define GAME_APP_NAME  "VoxelCraft 1.0.0 web"
#define GAME_APP_TITLE "VoxelCraft"
#else
#define GAME_APP_NAME  "VoxelCraft 1.0.0"
#define GAME_APP_TITLE "VoxelCraft 1.0.0"
#endif
...
/* Skin server: supports both player name (/name.png) and direct URL */
#define SKINS_SERVER    "https://mc-heads.net/skin"
/* No update/services server - offline fork */
#define UPDATES_SERVER  ""
#define SERVICES_SERVER ""
