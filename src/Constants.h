...
#define GAME_APP_ALT   "VoxelCraft 1.0 web mobile"
#define GAME_APP_NAME  "VoxelCraft 1.0 web"
#define GAME_APP_TITLE "VoxelCraft"
#else
#define GAME_APP_NAME  "VoxelCraft 1.0"
#define GAME_APP_TITLE "VoxelCraft 1.0"
#endif
